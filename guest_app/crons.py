...
class ClearSessionCronJob(CronJobBase):
    """
    Cron job that clears expired session on database. This job also
    will clear saved passport image file that saved using `session_key`
    as file name.
    """
    code        = 'guest_app.clear_session_cron_job'
