...
TOKEN_ENDPOINT = [
    {
        'type': 'guest_facing',
        'url': 'http://nginx-docker:80/container/77ks/oauth/token',
    ...
    },
    {
     ...
     {
        'type': 'guest_facing',
        'url': 'http://nginx-docker:80/container/81ks/oauth/token',
        'username': 'web-guest-client',
        'password': 'HotelTemplate1234',
        'timeout': 30,
    },
...
GUEST_ENDPOINT = [
    {
        ...
        'url': 'http://nginx-docker:80/container/77ks',
    ...
    },
    {
        ...
        'url': 'http://nginx-docker:80/container/81ks',
        'key': '36b682152421c5fcc2afe49fdafc77f84b029254b77a8af4c680b919725e5fa80f65d09df3c6311fc8f40cac9cc7fbea6a7d8dff6368af7d638abf041bd6ae45',
        'timeout': 30,
    }
]
